...
DEFAULT_START_TEXT = (
    "Hay, silahkan ketik pesanmu dibawah ini, nanti saya akan membalasanya Jika sudah online dan jangan spam ya😉.\n"
    "───────────────────────\n"
    "©Manage by : @FJ_GAMING"
)
...
DELETED_MESSAGES_NOTIFICATION_TEXT = get_config(
    ...
    (
        ...
        "Semoga bermanfaat dengan botnya😊"
    )
)
# IDEKWBYRW
